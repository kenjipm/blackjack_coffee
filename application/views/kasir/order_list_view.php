...
<?php
    ...
    foreach($orders as $order)
    {
        ...
        <form id="form_order_list-<?=$order->id?>" action="" target="" method="post">
            ...
            <input type="hidden" id="nama_customer" name="nama_customer" value="<?=$order->nama_pembeli?>"/>
			...
			<span class="order_header">
				...
				<span class="nama_pembeli"><?=$order->nama_pembeli?></span>
			</span>
            ...
            <input type="button" class="button_left <?=$order->paid?"semi_disabled":""?>" value="Cancel" onclick="delete_order(<?=$order->id?>, '<?=$order->nama_pembeli?>', <?=$order->paid?>)"/>
