...
<form id="form_menu_tambah" action="" target="" method="post">
	...
	<span class="order_header">
		...
		<span class="label">Nama Customer : </span> <input type="text" id="nama_customer" name="nama_customer" class="textbox" value="<?=isset($nama_customer)?$nama_customer:""?>" <?=($tipe =="count")?"readonly='readonly'":""?> autocomplete="off"/>
		<br/>
